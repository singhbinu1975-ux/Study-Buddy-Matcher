...
import { saveOnboardingData, AvailabilityBlock } from "@/app/actions/profile";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 text-left">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full h-12 flex items-center justify-center rounded-xl bg-gradient-to-r from-indigo-500 to-violet-500 hover:from-indigo-600 hover:to-violet-600 text-white font-semibold transition-all shadow-lg shadow-indigo-900/20 disabled:opacity-50"
      >
        {loading ? "Saving Profile..." : "Complete Setup & Match"}
      </button>
    </form>
  );
}
